...
export default function Landing() {
  ...
  useEffect(() => {
      ...
      entries.forEach(e => {
        ...
        metricData.forEach(m => {
          ...
          const tick = () => {
            ...
            el.textContent = (m.float ? (m.val * ease).toFixed(1) : Math.floor(m.val * ease)) + m.suffix
    ...
    const ms = document.querySelector('.metrics')
    if (ms) metObs.observe(ms)
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .cursor-ring {
          ...
          border: 1px solid rgba(107,184,212,0.5);
          transform: translate(-50%, -50%);
        ...
        .btn-primary {
          ...
          padding: 10px 24px; border: none; cursor: none;
        ...
        .hero-orb {
          ...
          background: radial-gradient(circle, rgba(107,184,212,0.06) 0%, transparent 65%);
        ...
        .hero-orb2 {
          ...
          background: radial-gradient(circle, rgba(107,184,212,0.04) 0%, transparent 65%);
        ...
        .hero-title-accent {
          ...
          letter-spacing: -.01em; text-transform: uppercase;
          color: transparent;
          -webkit-text-stroke: 1px rgba(107,184,212,0.5);
        ...
        .terminal {
          ...
          opacity: 0; animation: fadeLeft 1s ease 1.1s forwards;
        }
        .terminal::before {
          content: '';
        ...
        .divider::after {
          ...
          left: 0; top: 0; width: 120px; height: 1px;
        ...
        .metric-val span { color: var(--accent); font-weight: 300; }
        ...
        .cta-section::before {
          ...
          background: radial-gradient(circle, rgba(107,184,212,0.07) 0%, transparent 65%);
          pointer-events: none;
        }
        .cta-title {
          font-family: 'Rajdhani', sans-serif;
          font-size: clamp(48px, 8vw, 110px); font-weight: 700;
        ...
        .cta-title-ghost {
          ...
          text-transform: uppercase; letter-spacing: .02em; line-height: .9;
          color: transparent;
          -webkit-text-stroke: 1px rgba(107,184,212,0.3);
        ...
        .f-brand img { height: 22px; width: auto; opacity: .7; }
        .f-wordmark {
      ...
      <section className="hero">
        ...
        <div className="terminal">
          <div className="term-bar">
            <span className="term-dot td1"></span>
            <span className="term-dot td2"></span>
            <span className="term-dot td3"></span>
