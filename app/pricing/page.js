...
const MONTHLY_PRICE_ID = 'pri_01kr1d9pk07x8hpjd5qgk4sc9m'
const YEARLY_PRICE_ID = 'pri_01kr1djcfdy604fvaxts22zjrf'
      ...
      <div className="pricing-page">
        ...
        <div className="plans">
          <div className="plan">
            ...
            <button className="plan-btn" onClick={() => handleCheckout(MONTHLY_PRICE_ID)}>
              Get started →
            </button>
          </div>
          ...
          <div className="plan featured">
            ...
            <button className="plan-btn primary" onClick={() => handleCheckout(YEARLY_PRICE_ID)}>
              Get started →
            </button>
          </div>
        </div>
